        ...
        return (  
            <div className='termes max-w-4xl'>
                ...
                <b>2. Service Description</b><br></br>
                    Rust&Co provides an online platform that facilitates the sale of vehicles considered as scrap. These vehicles are sold "as is" without any guarantee of operation or safety. Buyers must assess the condition of the vehicles at their own discretion.
                </p>
                <p className='mb-6'>
